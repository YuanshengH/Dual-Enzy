...
if __name__ == "__main__":
    ...
    parser.add_argument('--feat_path', default='./data/train_data/feat.npy', help="Feature bank initialized features")
    parser.add_argument('--lb_path', default='./data/train_data/lb.npy', help="Feature bank initialized label")
