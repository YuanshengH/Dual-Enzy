...
if not os.path.exists('./data/DUF_dataset/enzyme_emb.lmdb'):
    env = lmdb.open('./data/DUF_dataset/enzyme_emb.lmdb', map_size=1099511627776)
...
if not os.path.exists('./data/DUF_dataset/reaction_emb.lmdb'):
    env = lmdb.open('./data/DUF_dataset/reaction_emb.lmdb', map_size=1099511627776)
    ...
    with open('./data/DUF_dataset/DUF_reaction_dict.pk', 'wb') as f:
