...
def main(args):
    ...
    with open('./data/OleA_dataset/OleA_reaction_dict.pk', 'rb') as f:
    ...
    valid_dataset = SubstrateDataset(reactant_id=valid_df['reactant_id'].values.tolist(), product_id=valid_df['product_id'].values.tolist(),
                                ...
                                mol_env_path='./data/OleA_dataset/reaction_emb.lmdb', esm_env_path='./data/OleA_dataset/enzyme_emb.lmdb')
    ...
    args.ckpt = os.path.join(args.ckpt, f'olea_ckpt_{args.split_method}.pt')     
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_path', default='./log/OleA_match_train.log', type=str)
